...
function init3DObjects() {
  ...
  // 3D object configurations - fewer than daybreak-dark-3d to make room for 2D shapes
  const configs = [
    { type: 'cube', x: 12, y: 25, speedY: 0.3, bobSpeed: 0.8, color: '255, 87, 87' },
    { type: 'cube', x: 82, y: 22, speedY: -0.4, speedX: 0.2, bobSpeed: 1.2, color: '129, 140, 248' },
    { type: 'pyramid', x: 50, y: 60, speedY: 0.15, bobSpeed: 0.5, bobAmount: 8, color: '129, 140, 248' },
    { type: 'cube', x: 88, y: 65, speedY: 0.35, bobSpeed: 0.9, color: '139, 92, 246' }
  ];
