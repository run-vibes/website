/**
 * Daybreak Dark - CSS 3D Floating Objects
 * Colors optimized for dark backgrounds with glow effects
 */
function init3DObjects() {
  ...
  // Create objects - brighter colors for dark backgrounds
  const configs = [
    { type: 'cube', x: 15, y: 25, speedY: 0.3, bobSpeed: 0.8, color: '255, 87, 87' },
    { type: 'cube', x: 75, y: 20, speedY: -0.4, speedX: 0.2, bobSpeed: 1.2, color: '129, 140, 248' },
    { type: 'cube', x: 60, y: 70, speedY: 0.5, bobSpeed: 0.6, color: '161, 161, 170' },
    { type: 'cube', x: 25, y: 65, speedY: -0.3, speedZ: 0.1, bobSpeed: 1, color: '255, 100, 100' },
    { type: 'cube', x: 85, y: 55, speedY: 0.4, bobSpeed: 0.9, color: '139, 92, 246' }
  ];
