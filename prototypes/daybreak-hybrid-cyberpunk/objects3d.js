...
function init3DObjects() {
  ...
  // 3D object configurations - Cyberpunk colors (neon pink + electric cyan)
  const configs = [
    { type: 'cube', x: 12, y: 25, speedY: 0.3, bobSpeed: 0.8, color: '255, 45, 146' },
    { type: 'cube', x: 82, y: 22, speedY: -0.4, speedX: 0.2, bobSpeed: 1.2, color: '0, 240, 255' },
    { type: 'pyramid', x: 50, y: 60, speedY: 0.15, bobSpeed: 0.5, bobAmount: 8, color: '0, 240, 255' },
    { type: 'cube', x: 88, y: 65, speedY: 0.35, bobSpeed: 0.9, color: '255, 45, 146' }
  ];
